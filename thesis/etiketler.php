...
$etiketler = $db->query("
SELECT k.keywordName FROM keyword k
")->fetchAll(5);
...
if (isset($_POST['submit_button'])) { 
    ...
    $sql = "INSERT INTO keyword (keywordName) 
    VALUES (?)";
    $stmt= $db->prepare($sql);
    $stmt->execute($params);

    header("Location: ./etiketler");
    die();
}
?>
<!doctype html>
...
<body>
    ...
    <nav class="container" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Anahtar Kelimeler</li>
        </ol>
    </nav>
        ...
        <div class="collapse" id="collapseExample" style="">
            <div class="card card-body">
                <form method="POST">
                    ...
                    <input type="text" class="form-control" placeholder="Lütfen giriniz" name="keywordName" value=""  required>
                    <br>

...
if (isset($_POST['submit_button'])) { 
    ...
    $sql = "INSERT INTO subject (subjectName) 
    VALUES (?)";
    $stmt= $db->prepare($sql);
    $stmt->execute($params);

    header("Location: ./konular");
    die();
}
?>
<!doctype html>
    ...
    <main class="container">
        ...
        <table id="tbl_thesis" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $konu->subjectName ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <div class="collapse" id="collapseExample" style="">
            <div class="card card-body">
                <form method="POST">
                    ...
                    <input type="text" class="form-control" placeholder="Lütfen giriniz" name="subjectName" value="" required>
                    <br>
